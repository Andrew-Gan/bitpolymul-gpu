...
void bc_to_lch_256_30_12(u256* poly, int logn) {
    ...
    //     for(int i=offset-1-524284;i>=offset-524286;--i)poly[i]^=poly[i+524286]^poly[i+524287];
        // for(int fset-1-535822336;i>=offset-536739840;--i)poly[i]^=poly[i+536739840]^poly[i+536805376]^poly[i+536862720]^poly[i+536866816]^poly[i+536870400]^poly[i+536870656]^poly[i+536870880]^poly[i+536870896]^poly[i+536870910]^poly[i+536870911];
...
static
void bc_to_lch_256_19_17(u256* poly, int logn){
...
void bc_to_lch_256_16(u256* poly, int logn){
    ...
    blockY = ((1<<logn)-(1<<15)+(1<<16)-1) >> 16;
    xor_gpu<<<dim3(8, blockY, 8), 1024>>>(poly, (1<<15)-24576, 1<<15, 1<<16, 16384);
    xor_gpu<<<dim3(4, blockY, 8), 1024>>>(poly, (1<<15)-28672, 1<<15, 1<<16, 16384, 24576);
    xor_gpu<<<dim3(2, blockY, 8), 1024>>>(poly, (1<<15)-30720, 1<<15, 1<<16, 16384, 24576, 28672);
    xor_gpu<<<dim3(1, blockY, 8), 1024>>>(poly, (1<<15)-31744, 1<<15, 1<<16, 16384, 24576, 28672, 30720);
    xor_gpu<<<dim3(1, blockY, 8), 512>>>(poly, (1<<15)-32256, 1<<15, 1<<16, 16384, 24576, 28672, 30720, 31744);
    xor_gpu<<<dim3(1, blockY, 8), 256>>>(poly, (1<<15)-32512, 1<<15, 1<<16, 16384, 24576, 28672, 30720, 31744, 32256);
    xor_gpu<<<dim3(1, blockY, 8), 128>>>(poly, (1<<15)-32640, 1<<15, 1<<16, 16384, 24576, 28672, 30720, 31744, 32256, 32512);
    xor_gpu<<<dim3(1, blockY, 8), 64>>>(poly, (1<<15)-32704, 1<<15, 1<<16, 16384, 24576, 28672, 30720, 31744, 32256, 32512, 32640);
    xor_gpu<<<dim3(1, blockY, 8), 32>>>(poly, (1<<15)-32736, 1<<15, 1<<16, 16384, 24576, 28672, 30720, 31744, 32256, 32512, 32640, 32704);
    xor_gpu<<<dim3(1, blockY, 8), 16>>>(poly, (1<<15)-32752, 1<<15, 1<<16, 16384, 24576, 28672, 30720, 31744, 32256, 32512, 32640, 32704, 32736);
    xor_gpu<<<dim3(1, blockY, 8), 8>>>(poly, (1<<15)-32760, 1<<15, 1<<16, 16384, 24576, 28672, 30720, 31744, 32256, 32512, 32640, 32704, 32736, 32752);
    xor_gpu<<<dim3(1, blockY, 8), 4>>>(poly, (1<<15)-32764, 1<<15, 1<<16, 16384, 24576, 28672, 30720, 31744, 32256, 32512, 32640, 32704, 32736, 32752, 32760);
    xor_gpu<<<dim3(1, blockY, 8), 2>>>(poly, (1<<15)-32766, 1<<15, 1<<16, 16384, 24576, 28672, 30720, 31744, 32256, 32512, 32640, 32704, 32736, 32752, 32760, 32764);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<15)-32767, 1<<15, 1<<16, 16384, 24576, 28672, 30720, 31744, 32256, 32512, 32640, 32704, 32736, 32752, 32760, 32764, 32766);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<15)-32768, 1<<15, 1<<16, 16384, 24576, 28672, 30720, 31744, 32256, 32512, 32640, 32704, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(16, blockY, 8), 1024>>>(poly, -16384, 1<<15, 1<<16, 16384, 24576, 28672, 30720, 31744, 32256, 32512, 32640, 32704, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(8, blockY, 8), 1024>>>(poly, -24576, 1<<15, 1<<16, 24576, 28672, 30720, 31744, 32256, 32512, 32640, 32704, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(4, blockY, 8), 1024>>>(poly, -28672, 1<<15, 1<<16, 28672, 30720, 31744, 32256, 32512, 32640, 32704, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(2, blockY, 8), 1024>>>(poly, -30720, 1<<15, 1<<16, 30720, 31744, 32256, 32512, 32640, 32704, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY, 8), 1024>>>(poly, -31744, 1<<15, 1<<16, 31744, 32256, 32512, 32640, 32704, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY, 8), 512>>>(poly, -32256, 1<<15, 1<<16, 32256, 32512, 32640, 32704, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY, 8), 256>>>(poly, -32512, 1<<15, 1<<16, 32512, 32640, 32704, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY, 8), 128>>>(poly, -32640, 1<<15, 1<<16, 32640, 32704, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY, 8), 64>>>(poly, -32704, 1<<15, 1<<16, 32704, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY, 8), 32>>>(poly, -32736, 1<<15, 1<<16, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY, 8), 16>>>(poly, -32752, 1<<15, 1<<16, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY, 8), 8>>>(poly, -32760, 1<<15, 1<<16, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY, 8), 4>>>(poly, -32764, 1<<15, 1<<16, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY, 8), 2>>>(poly, -32766, 1<<15, 1<<16, 32766, 32767);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, -32767, 1<<15, 1<<16, 32767);
    ...
    blockY = ((1<<logn)-(1<<14)+(1<<15)-1) >> 15;
    xor_gpu<<<dim3(3, blockY, 8), 1024>>>(poly, (1<<14)-15360, 1<<14, 1<<15, 12288);
    xor_gpu<<<dim3(1, blockY, 8), 768>>>(poly, (1<<14)-16128, 1<<14, 1<<15, 12288, 15360);
    xor_gpu<<<dim3(1, blockY, 8), 192>>>(poly, (1<<14)-16320, 1<<14, 1<<15, 12288, 15360, 16128);
    xor_gpu<<<dim3(1, blockY, 8), 48>>>(poly, (1<<14)-16368, 1<<14, 1<<15, 12288, 15360, 16128, 16320);
    xor_gpu<<<dim3(1, blockY, 8), 12>>>(poly, (1<<14)-16380, 1<<14, 1<<15, 12288, 15360, 16128, 16320, 16368);
    xor_gpu<<<dim3(1, blockY, 8), 3>>>(poly, (1<<14)-16383, 1<<14, 1<<15, 12288, 15360, 16128, 16320, 16368, 16380);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<14)-16384, 1<<14, 1<<15, 12288, 15360, 16128, 16320, 16368, 16380, 16383);
    xor_gpu<<<dim3(12, blockY, 8), 1024>>>(poly, -12288, 1<<14, 1<<15, 12288, 15360, 16128, 16320, 16368, 16380, 16383);
    xor_gpu<<<dim3(3, blockY, 8), 1024>>>(poly, -15360, 1<<14, 1<<15, 15360, 16128, 16320, 16368, 16380, 16383);
    xor_gpu<<<dim3(1, blockY, 8), 768>>>(poly, -16128, 1<<14, 1<<15, 16128, 16320, 16368, 16380, 16383);
    xor_gpu<<<dim3(1, blockY, 8), 192>>>(poly, -16320, 1<<14, 1<<15, 16320, 16368, 16380, 16383);
    xor_gpu<<<dim3(1, blockY, 8), 48>>>(poly, -16368, 1<<14, 1<<15, 16368, 16380, 16383);
    xor_gpu<<<dim3(1, blockY, 8), 12>>>(poly, -16380, 1<<14, 1<<15, 16380, 16383);
    xor_gpu<<<dim3(1, blockY, 8), 3>>>(poly, -16383, 1<<14, 1<<15, 16383);
    ...
    blockY = ((1<<logn)-(1<<13)+(1<<14)-1) >> 14;
    xor_gpu<<<dim3(7, blockY, 8), 512>>>(poly, (1<<13)-7680, 1<<13, 1<<14, 4096);
    xor_gpu<<<dim3(1, blockY, 8), 256>>>(poly, (1<<13)-7936, 1<<13, 1<<14, 4096, 7680);
    xor_gpu<<<dim3(1, blockY, 8), 224>>>(poly, (1<<13)-8160, 1<<13, 1<<14, 4096, 7680, 7936);
    xor_gpu<<<dim3(1, blockY, 8), 16>>>(poly, (1<<13)-8176, 1<<13, 1<<14, 4096, 7680, 7936, 8160);
    xor_gpu<<<dim3(1, blockY, 8), 14>>>(poly, (1<<13)-8190, 1<<13, 1<<14, 4096, 7680, 7936, 8160, 8176);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<13)-8191, 1<<13, 1<<14, 4096, 7680, 7936, 8160, 8176, 8190);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<13)-8192, 1<<13, 1<<14, 4096, 7680, 7936, 8160, 8176, 8190, 8191);
    xor_gpu<<<dim3(4, blockY, 8), 1024>>>(poly, -4096, 1<<13, 1<<14, 4096, 7680, 7936, 8160, 8176, 8190, 8191);
    xor_gpu<<<dim3(7, blockY, 8), 512>>>(poly, -7680, 1<<13, 1<<14, 7680, 7936, 8160, 8176, 8190, 8191);
    xor_gpu<<<dim3(1, blockY, 8), 256>>>(poly, -7936, 1<<13, 1<<14, 7936, 8160, 8176, 8190, 8191);
    xor_gpu<<<dim3(1, blockY, 8), 224>>>(poly, -8160, 1<<13, 1<<14, 8160, 8176, 8190, 8191);
    xor_gpu<<<dim3(1, blockY, 8), 16>>>(poly, -8176, 1<<13, 1<<14, 8176, 8190, 8191);
    xor_gpu<<<dim3(1, blockY, 8), 14>>>(poly, -8190, 1<<13, 1<<14, 8190, 8191);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, -8191, 1<<13, 1<<14, 8191);
    ...
    blockY = ((1<<logn)-(1<<12)+(1<<13)-1) >> 13;
    xor_gpu<<<dim3(1, blockY, 8), 240>>>(poly, (1<<12)-4080, 1<<12, 1<<13, 3840);
    xor_gpu<<<dim3(1, blockY, 8), 15>>>(poly, (1<<12)-4095, 1<<12, 1<<13, 3840, 4080);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<12)-4096, 1<<12, 1<<13, 3840, 4080, 4095);
    xor_gpu<<<dim3(15, blockY, 8), 256>>>(poly, -3840, 1<<12, 1<<13, 3840, 4080, 4095);
    xor_gpu<<<dim3(1, blockY, 8), 240>>>(poly, -4080, 1<<12, 1<<13, 4080, 4095);
    xor_gpu<<<dim3(1, blockY, 8), 15>>>(poly, -4095, 1<<12, 1<<13, 4095);
    ...
    blockY = ((1<<logn)-(1<<11)+(1<<12)-1) >> 12;
    xor_gpu<<<dim3(1, blockY, 8), 512>>>(poly, (1<<11)-1536, 1<<11, 1<<12, 1024);
    xor_gpu<<<dim3(1, blockY, 8), 256>>>(poly, (1<<11)-1792, 1<<11, 1<<12, 1024, 1536);
    xor_gpu<<<dim3(1, blockY, 8), 248>>>(poly, (1<<11)-2040, 1<<11, 1<<12, 1024, 1536, 1792);
    xor_gpu<<<dim3(1, blockY, 8), 4>>>(poly, (1<<11)-2044, 1<<11, 1<<12, 1024, 1536, 1792, 2040);
    xor_gpu<<<dim3(1, blockY, 8), 2>>>(poly, (1<<11)-2046, 1<<11, 1<<12, 1024, 1536, 1792, 2040, 2044);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<11)-2047, 1<<11, 1<<12, 1024, 1536, 1792, 2040, 2044, 2046);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<11)-2048, 1<<11, 1<<12, 1024, 1536, 1792, 2040, 2044, 2046, 2047);
    xor_gpu<<<dim3(1, blockY, 8), 512>>>(poly, -1536, 1<<11, 1<<12, 1536, 1792, 2040, 2044, 2046, 2047);
    xor_gpu<<<dim3(1, blockY, 8), 256>>>(poly, -1792, 1<<11, 1<<12, 1792, 2040, 2044, 2046, 2047);
    xor_gpu<<<dim3(1, blockY, 8), 248>>>(poly, -2040, 1<<11, 1<<12, 2040, 2044, 2046, 2047);
    xor_gpu<<<dim3(1, blockY, 8), 4>>>(poly, -2044, 1<<11, 1<<12, 2044, 2046, 2047);
    xor_gpu<<<dim3(1, blockY, 8), 2>>>(poly, -2046, 1<<11, 1<<12, 2046, 2047);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, -2047, 1<<11, 1<<12, 2047);
    ...
    blockY = ((1<<logn)-(1<<10)+(1<<11)-1) >> 11;
    xor_gpu<<<dim3(1, blockY, 8), 252>>>(poly, (1<<10)-1020, 1<<10, 1<<11, 768);
    xor_gpu<<<dim3(1, blockY, 8), 3>>>(poly, (1<<10)-1023, 1<<10, 1<<11, 768, 1020);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<10)-1024, 1<<10, 1<<11, 768, 1020, 1023);
    xor_gpu<<<dim3(1, blockY, 8), 768>>>(poly, -768, 1<<10, 1<<11, 768, 1020, 1023);
    xor_gpu<<<dim3(1, blockY, 8), 252>>>(poly, -1020, 1<<10, 1<<11, 1020, 1023);
    xor_gpu<<<dim3(1, blockY, 8), 3>>>(poly, -1023, 1<<10, 1<<11, 1023);
    ...
    blockY = ((1<<logn)-(1<<9)+(1<<10)-1) >> 10;
    xor_gpu<<<dim3(1, blockY, 8), 254>>>(poly, (1<<9)-510, 1<<9, 1<<10, 256);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<9)-511, 1<<9, 1<<10, 256, 510);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<9)-512, 1<<9, 1<<10, 256, 510, 511);
    xor_gpu<<<dim3(1, blockY, 8), 256>>>(poly, -256, 1<<9, 1<<10, 256, 510, 511);
    xor_gpu<<<dim3(1, blockY, 8), 254>>>(poly, -510, 1<<9, 1<<10, 510, 511);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, -511, 1<<9, 1<<10, 511);
    ...
    blockY = ((1<<logn)-(1<<8)+(1<<9)-1) >> 9;
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<8)-256, 1<<8, 1<<9, 255);
    xor_gpu<<<dim3(1, blockY, 8), 255>>>(poly, -255, 1<<8, 1<<9, 255);
    ...
    blockY = ((1<<logn)-(1<<7)+(1<<8)-1) >> 8;
    xor_gpu<<<dim3(1, blockY, 8), 32>>>(poly, (1<<7)-96, 1<<7, 1<<8, 64);
    xor_gpu<<<dim3(1, blockY, 8), 16>>>(poly, (1<<7)-112, 1<<7, 1<<8, 64, 96);
    xor_gpu<<<dim3(1, blockY, 8), 8>>>(poly, (1<<7)-120, 1<<7, 1<<8, 64, 96, 112);
    xor_gpu<<<dim3(1, blockY, 8), 4>>>(poly, (1<<7)-124, 1<<7, 1<<8, 64, 96, 112, 120);
    xor_gpu<<<dim3(1, blockY, 8), 2>>>(poly, (1<<7)-126, 1<<7, 1<<8, 64, 96, 112, 120, 124);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<7)-127, 1<<7, 1<<8, 64, 96, 112, 120, 124, 126);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<7)-128, 1<<7, 1<<8, 64, 96, 112, 120, 124, 126, 127);
    xor_gpu<<<dim3(1, blockY, 8), 64>>>(poly, -64, 1<<7, 1<<8, 64, 96, 112, 120, 124, 126, 127);
    xor_gpu<<<dim3(1, blockY, 8), 32>>>(poly, -96, 1<<7, 1<<8, 96, 112, 120, 124, 126, 127);
    xor_gpu<<<dim3(1, blockY, 8), 16>>>(poly, -112, 1<<7, 1<<8, 112, 120, 124, 126, 127);
    xor_gpu<<<dim3(1, blockY, 8), 8>>>(poly, -120, 1<<7, 1<<8, 120, 124, 126, 127);
    xor_gpu<<<dim3(1, blockY, 8), 4>>>(poly, -124, 1<<7, 1<<8, 124, 126, 127);
    xor_gpu<<<dim3(1, blockY, 8), 2>>>(poly, -126, 1<<7, 1<<8, 126, 127);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, -127, 1<<7, 1<<8, 127);
    ...
    blockY = ((1<<logn)-(1<<6)+(1<<7)-1) >> 7;
    xor_gpu<<<dim3(1, blockY, 8), 12>>>(poly, (1<<6)-60, 1<<6, 1<<7, 48);
    xor_gpu<<<dim3(1, blockY, 8), 3>>>(poly, (1<<6)-63, 1<<6, 1<<7, 48, 60);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<6)-64, 1<<6, 1<<7, 48, 60, 63);
    xor_gpu<<<dim3(1, blockY, 8), 48>>>(poly, -48, 1<<6, 1<<7, 48, 60, 63);
    xor_gpu<<<dim3(1, blockY, 8), 12>>>(poly, -60, 1<<6, 1<<7, 60, 63);
    xor_gpu<<<dim3(1, blockY, 8), 3>>>(poly, -63, 1<<6, 1<<7, 63);
    ...
    blockY = ((1<<logn)-(1<<5)+(1<<6)-1) >> 6;
    xor_gpu<<<dim3(1, blockY, 8), 14>>>(poly, (1<<5)-30, 1<<5, 1<<6, 16);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<5)-31, 1<<5, 1<<6, 16, 30);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<5)-32, 1<<5, 1<<6, 16, 30, 31);
    xor_gpu<<<dim3(1, blockY, 8), 16>>>(poly, -16, 1<<5, 1<<6, 16, 30, 31);
    xor_gpu<<<dim3(1, blockY, 8), 14>>>(poly, -30, 1<<5, 1<<6, 30, 31);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, -31, 1<<5, 1<<6, 31);
    ...
    blockY = ((1<<logn)-(1<<4)+(1<<5)-1) >> 5;
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<4)-16, 1<<4, 1<<5, 15);
    xor_gpu<<<dim3(1, blockY, 8), 15>>>(poly, -15, 1<<4, 1<<5, 15);
    ...
    blockY = ((1<<logn)-(1<<3)+(1<<4)-1) >> 4;
    xor_gpu<<<dim3(1, blockY, 8), 2>>>(poly, (1<<3)-6, 1<<3, 1<<4, 4);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<3)-7, 1<<3, 1<<4, 4, 6);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<3)-8, 1<<3, 1<<4, 4, 6, 7);
    xor_gpu<<<dim3(1, blockY, 8), 4>>>(poly, -4, 1<<3, 1<<4, 4, 6, 7);
    xor_gpu<<<dim3(1, blockY, 8), 2>>>(poly, -6, 1<<3, 1<<4, 6, 7);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, -7, 1<<3, 1<<4, 7);
    ...
    blockY = ((1<<logn)-(1<<2)+(1<<3)-1) >> 3;
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<2)-4, 1<<2, 1<<3, 3);
    xor_gpu<<<dim3(1, blockY, 8), 3>>>(poly, -3, 1<<2, 1<<3, 3);
    ...
    blockY = ((1<<logn)-(1<<1)+(1<<2)-1) >> 2;
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, (1<<1)-2, 1<<1, 1<<2, 1);
    xor_gpu<<<dim3(1, blockY, 8), 1>>>(poly, -1, 1<<1, 1<<2, 1);
    ...
    // for (int i = 0; i < 14; i++) {
    //     float loopDuration = (t[i+1].tv_sec - t[i].tv_sec) * 1000;
    //     loopDuration += (t[i+1].tv_nsec - t[i].tv_nsec) / 1000000.0;
    //     printf("Loop %d: %.2f ms\n", i, loopDuration);
    // }
}
