    xor_gpu<<<dim3(1, blockY), 128>>>(poly, -32640, 1<<15, 1<<16, 32640, 32704, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY), 64>>>(poly, -32704, 1<<15, 1<<16, 32704, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY), 32>>>(poly, -32736, 1<<15, 1<<16, 32736, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY), 16>>>(poly, -32752, 1<<15, 1<<16, 32752, 32760, 32764, 32766, 32767);
    xor_gpu<<<dim3(1, blockY), 8>>>(poly, -32760, 1<<15, 1<<16, 32760, 32764, 32766, 32767);
    ...
    xor_gpu<<<dim3(1, blockY), 48>>>(poly, (1<<14)-16368, 1<<14, 1<<15, 12288, 15360, 16128, 16320);
    xor_gpu<<<dim3(1, blockY), 12>>>(poly, (1<<14)-16380, 1<<14, 1<<15, 12288, 15360, 16128, 16320, 16368);
    xor_gpu<<<dim3(1, blockY), 3>>>(poly, (1<<14)-16383, 1<<14, 1<<15, 12288, 15360, 16128, 16320, 16368, 16380);
    xor_gpu<<<dim3(1, blockY), 1>>>(poly, (1<<14)-16384, 1<<14, 1<<15, 12288, 15360, 16128, 16320, 16368, 16380, 16383);
    ...
    xor_gpu<<<dim3(1, blockY), 16>>>(poly, (1<<13)-8176, 1<<13, 1<<14, 4096, 7680, 7936, 8160);
    xor_gpu<<<dim3(1, blockY), 14>>>(poly, (1<<13)-8190, 1<<13, 1<<14, 4096, 7680, 7936, 8160, 8176);
    xor_gpu<<<dim3(1, blockY), 1>>>(poly, (1<<13)-8191, 1<<13, 1<<14, 4096, 7680, 7936, 8160, 8176, 8190);
    xor_gpu<<<dim3(1, blockY), 1>>>(poly, (1<<13)-8192, 1<<13, 1<<14, 4096, 7680, 7936, 8160, 8176, 8190, 8191);
    xor_gpu<<<dim3(4, blockY), 1024>>>(poly, -4096, 1<<13, 1<<14, 4096, 7680, 7936, 8160, 8176, 8190, 8191);
    xor_gpu<<<dim3(7, blockY), 512>>>(poly, -7680, 1<<13, 1<<14, 7680, 7936, 8160, 8176, 8190, 8191);
    xor_gpu<<<dim3(1, blockY), 256>>>(poly, -7936, 1<<13, 1<<14, 7936, 8160, 8176, 8190, 8191);
    xor_gpu<<<dim3(1, blockY), 224>>>(poly, -8160, 1<<13, 1<<14, 8160, 8176, 8190, 8191);
    xor_gpu<<<dim3(1, blockY), 16>>>(poly, -8176, 1<<13, 1<<14, 8176, 8190, 8191);
    xor_gpu<<<dim3(1, blockY), 14>>>(poly, -8190, 1<<13, 1<<14, 8190, 8191);
    xor_gpu<<<dim3(1, blockY), 1>>>(poly, -8191, 1<<13, 1<<14, 8191);
    ...
    xor_gpu<<<dim3(15, blockY), 256>>>(poly, -3840, 1<<12, 1<<13, 3840, 4080, 4095);
    xor_gpu<<<dim3(1, blockY), 240>>>(poly, -4080, 1<<12, 1<<13, 4080, 4095);
    xor_gpu<<<dim3(1, blockY), 15>>>(poly, -4095, 1<<12, 1<<13, 4095);
    ...
    xor_gpu<<<dim3(1, blockY), 4>>>(poly, (1<<11)-2044, 1<<11, 1<<12, 1024, 1536, 1792, 2040);
    xor_gpu<<<dim3(1, blockY), 2>>>(poly, (1<<11)-2046, 1<<11, 1<<12, 1024, 1536, 1792, 2040, 2044);
    xor_gpu<<<dim3(1, blockY), 1>>>(poly, (1<<11)-2047, 1<<11, 1<<12, 1024, 1536, 1792, 2040, 2044, 2046);
    xor_gpu<<<dim3(1, blockY), 1>>>(poly, (1<<11)-2048, 1<<11, 1<<12, 1024, 1536, 1792, 2040, 2044, 2046, 2047);
    xor_gpu<<<dim3(1, blockY), 512>>>(poly, -1536, 1<<11, 1<<12, 1536, 1792, 2040, 2044, 2046, 2047);
    xor_gpu<<<dim3(1, blockY), 256>>>(poly, -1792, 1<<11, 1<<12, 1792, 2040, 2044, 2046, 2047);
    xor_gpu<<<dim3(1, blockY), 248>>>(poly, -2040, 1<<11, 1<<12, 2040, 2044, 2046, 2047);
    xor_gpu<<<dim3(1, blockY), 4>>>(poly, -2044, 1<<11, 1<<12, 2044, 2046, 2047);
    xor_gpu<<<dim3(1, blockY), 2>>>(poly, -2046, 1<<11, 1<<12, 2046, 2047);
    xor_gpu<<<dim3(1, blockY), 1>>>(poly, -2047, 1<<11, 1<<12, 2047);
    ...
    xor_gpu<<<dim3(1, blockY), 768>>>(poly, -768, 1<<10, 1<<11, 768, 1020, 1023);
    xor_gpu<<<dim3(1, blockY), 252>>>(poly, -1020, 1<<10, 1<<11, 1020, 1023);
    xor_gpu<<<dim3(1, blockY), 3>>>(poly, -1023, 1<<10, 1<<11, 1023);
    ...
    xor_gpu<<<dim3(1, blockY), 256>>>(poly, -256, 1<<9, 1<<10, 256, 510, 511);
    xor_gpu<<<dim3(1, blockY), 254>>>(poly, -510, 1<<9, 1<<10, 510, 511);
    xor_gpu<<<dim3(1, blockY), 1>>>(poly, -511, 1<<9, 1<<10, 511);
    ...
    xor_gpu<<<dim3(1, blockY), 4>>>(poly, (1<<7)-124, 1<<7, 1<<8, 64, 96, 112, 120);
    xor_gpu<<<dim3(1, blockY), 2>>>(poly, (1<<7)-126, 1<<7, 1<<8, 64, 96, 112, 120, 124);
    xor_gpu<<<dim3(1, blockY), 1>>>(poly, (1<<7)-127, 1<<7, 1<<8, 64, 96, 112, 120, 124, 126);
    xor_gpu<<<dim3(1, blockY), 1>>>(poly, (1<<7)-128, 1<<7, 1<<8, 64, 96, 112, 120, 124, 126, 127);
    xor_gpu<<<dim3(1, blockY), 64>>>(poly, -64, 1<<7, 1<<8, 64, 96, 112, 120, 124, 126, 127);
    xor_gpu<<<dim3(1, blockY), 32>>>(poly, -96, 1<<7, 1<<8, 96, 112, 120, 124, 126, 127);
    xor_gpu<<<dim3(1, blockY), 16>>>(poly, -112, 1<<7, 1<<8, 112, 120, 124, 126, 127);
    xor_gpu<<<dim3(1, blockY), 8>>>(poly, -120, 1<<7, 1<<8, 120, 124, 126, 127);
    xor_gpu<<<dim3(1, blockY), 4>>>(poly, -124, 1<<7, 1<<8, 124, 126, 127);
    xor_gpu<<<dim3(1, blockY), 2>>>(poly, -126, 1<<7, 1<<8, 126, 127);
    xor_gpu<<<dim3(1, blockY), 1>>>(poly, -127, 1<<7, 1<<8, 127);
    ...
    xor_gpu<<<dim3(1, blockY), 48>>>(poly, -48, 1<<6, 1<<7, 48, 60, 63);
    xor_gpu<<<dim3(1, blockY), 12>>>(poly, -60, 1<<6, 1<<7, 60, 63);
    xor_gpu<<<dim3(1, blockY), 3>>>(poly, -63, 1<<6, 1<<7, 63);
    ...
    xor_gpu<<<dim3(1, blockY), 16>>>(poly, -16, 1<<5, 1<<6, 16, 30, 31);
    xor_gpu<<<dim3(1, blockY), 14>>>(poly, -30, 1<<5, 1<<6, 30, 31);
    xor_gpu<<<dim3(1, blockY), 1>>>(poly, -31, 1<<5, 1<<6, 31);
    ...
    xor_gpu<<<dim3(1, blockY), 4>>>(poly, -4, 1<<3, 1<<4, 4, 6, 7);
